...
afin **d'ajouter des fonctionnalités**. L'application est une application de gestion de feuille process, c'est-à-
dire que l'on peut y réaliser des relevés de caractéristiques sur des produits en production.
...
Le dashboard propose un système de filtrage composé de quatre sélecteurs principaux visible sur le panneau de gauche (
